...
# muestra el árbol de sintaxis abstracta de una expresión.
...
@code_typed suma(1, 1)
#muestra el código después de la inferencia de tipos automática.
#1-element Array{Any,1}:
...
#
@code_llvm suma(1, 1)
#muestra el código intermedio de LLVM.
...
#emite advertencias sobre inestabilidad de tipos.
#Variables:
  #x::Int64
  #y::Int64
#
